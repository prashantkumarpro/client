...
import { FolderGrid } from '../features/folders/components/folder-grid';
...
export default function DashboardPage() {
  ...
  const handleQuickAction = (action: 'upload-file' | 'create-folder' | 'share' | 'get-link') => {
  ...
  const getActivityIcon = (type: string) => {
    ...
    switch (type) {
      case 'upload':
        ...
        return (
          <div className={cn(baseClass, "bg-emerald-50 dark:bg-emerald-950/20 text-emerald-600 dark:text-emerald-400 border-emerald-100 dark:border-emerald-900/30")}>
      ...
      case 'share':
        ...
        return (
          <div className={cn(baseClass, "bg-purple-50 dark:bg-purple-950/20 text-purple-600 dark:text-purple-400 border-purple-100 dark:border-purple-900/30")}>
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      case 'create_folder':
        ...
        return (
          <div className={cn(baseClass, "bg-blue-50 dark:bg-blue-950/20 text-[#2563eb] dark:text-blue-400 border-blue-100 dark:border-blue-900/30")}>
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      case 'star':
        ...
        return (
          <div className={cn(baseClass, "bg-amber-50 dark:bg-amber-950/20 text-amber-600 dark:text-amber-400 border-amber-100 dark:border-amber-900/30")}>
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      case 'delete':
        ...
        return (
          <div className={cn(baseClass, "bg-rose-50 dark:bg-rose-950/20 text-rose-600 dark:text-rose-400 border-rose-100 dark:border-rose-900/30")}>
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      default:
        return (
          <div className={cn(baseClass, "bg-gray-50 dark:bg-gray-900 text-gray-500 border-gray-100 dark:border-gray-800")}>
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-8 flex flex-col gap-6 md:gap-8">
          ...
          {currentSection === 'Shared' && (
            <FileList title="Shared Assets" />
          )}

          {/* VIEW: Recent */}
          {currentSection === 'Recent' && (
            <FileList title="Recent Assets" />
          )}

          {/* VIEW: Starred */}
          {currentSection === 'Starred' && (
            <FileList title="Starred Assets" />
          )}
            ...
            <div className="bg-card-bg border border-card-border rounded-2xl p-6 text-foreground flex flex-col gap-6 shadow-sm">
              ...
              <div className="flex flex-col gap-4 font-light text-sm text-text-secondary">
                <div className="flex items-center justify-between p-4 bg-background border border-card-border rounded-xl">
                  <div>
                    <div className="text-xs font-bold text-foreground uppercase tracking-[0.5px]">Performance Mode</div>
                    <div className="text-[11px] text-text-muted mt-1">Accelerates transitions and UI layouts.</div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-background border border-card-border rounded-xl">
                  <div>
                    <div className="text-xs font-bold text-foreground uppercase tracking-[0.5px]">High Contrast Outlines</div>
                    <div className="text-[11px] text-text-muted mt-1">Thicken borders for enhanced visibility.</div>
                  </div>
