        ...
        <form onSubmit={handleUploadFile} className="flex flex-col gap-4 pt-2">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="w-full bg-input-bg text-foreground border border-card-border rounded-xl px-4 py-3 text-xs font-bold uppercase tracking-[1px] focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/10 cursor-pointer"
            >
