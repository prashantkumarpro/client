            ...
            trigger={
              <div className='flex items-center gap-2.5 px-3 py-1.5 rounded-xl hover:bg-slate-50 dark:hover:bg-zinc-900/60 cursor-pointer select-none transition-colors group'>
                <div className='w-8.5 h-8.5 rounded-full bg-divider border border-card-border overflow-hidden relative shrink-0'>
                  <div className='w-8.5 h-8.5 rounded-full bg-divider border border-card-border flex items-center justify-center shrink-0'>
                ...
                <svg
                  className='w-3 h-3 text-text-muted hidden md:block group-hover:text-foreground transition-transform duration-200 group-hover:translate-y-0.5'
                  fill='none'
                  viewBox='0 0 24 24'
                  stroke='currentColor'
                  strokeWidth={2}
